...
and charter-service record support a current certified in-service status. The
repository should therefore keep Mach 0.85 as the airline baseline and retain
both Mach 0.925 and Mach 0.935 as distinct certified business-aviation
references, without treating either as a universal airline or practicality
winner.
...
It records one airline-service row, two certified in-service business-aviation
rows, a highest published and service-anchored subsonic Mach of 0.935, and zero
...
- No practicality-matrix status changes follow. This phase promotes the G700
  from a conditional marketed reference to a certified in-service reference,
  while the supersonic Mach 2 anchor and unresolved gates remain unchanged.
