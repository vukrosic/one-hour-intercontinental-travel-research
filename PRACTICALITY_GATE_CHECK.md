...
The current seven rows all pass the semantic checks. The Mach 0.85 airline and Mach 0.925/Mach 0.935/Mach 0.95 business-aviation rows are explicitly non-ranked reference classes. This is a guard against editorial drift, not a new physical result or a weighted practicality score.
