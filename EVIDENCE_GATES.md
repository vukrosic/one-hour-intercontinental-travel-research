...
| Passenger acceleration/ride comfort | Unresolved | NASA reports active work on passenger comfort thresholds; FAA sources define pressurization evidence requirements | Public comfort/safety thresholds cannot be met across normal and off-normal conditions | Build a source-separated comfort, operational, and injury threshold table |
| Cabin environment | Partially supported | FAA AC 25-7D describes normal cabin-pressure-altitude evidence, including an 8,000 ft maximum in the cited certification context | No credible evidence for a habitable, certifiable cabin environment at the speed class | Compare certification requirements, not vehicle solutions |
