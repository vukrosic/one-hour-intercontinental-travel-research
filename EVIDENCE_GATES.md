...
| Independent verification | Partial: arithmetic gates, airport summary, and source register checked | Separate implementations reproduce energy, thermal, speed-tradeoff, and all seven airport-summary metrics; static source-register hygiene also passes | Results may still contain source-interpretation, external-data, passenger, or noise errors | Add source hashes and independent public replication of the evidence claims |
