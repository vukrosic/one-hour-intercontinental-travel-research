...
| Independent verification | Partial: arithmetic gates, airport summary, source register, and hash manifest checked | Separate implementations reproduce energy, thermal, speed-tradeoff, and all seven airport-summary metrics; static source hygiene and four-page SHA-256 manifest checks pass | Results may still contain source-interpretation, external-data, passenger, or noise errors | Add independent public replication of additional evidence claims |
