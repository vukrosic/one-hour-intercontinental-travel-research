...
class CurrentCivilianSpeedCloseReadTests(unittest.TestCase):
    def test_service_and_marketing_states_are_separate(self):
        ...
        self.assertEqual(summary["current_certified_business_aviation_rows"], 3)
    ...
    def test_service_frontier_does_not_include_marketed_claim(self):
        ...
        self.assertAlmostEqual(summary["highest_published_subsonic_mach"], 0.95)
        self.assertAlmostEqual(summary["highest_service_anchored_mach"], 0.95)
