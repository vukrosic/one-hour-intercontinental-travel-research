...
- **Current subsonic references:** `CURRENT_CIVILIAN_SPEED_CLOSE_READ.md` separates a Mach 0.85 airline-service baseline from two certified in-service business-aviation references at Mach 0.925 and Mach 0.935 (Global 7500 and G700).
